...
function love.load()
    ...
    car.fixture = love.physics.newFixture(car.body, car.shape, 0)  --把矩形附加到汽车
    ...
    bomb.shape = love.physics.newRectangleShape(240,32) --创建一个矩形大小为炸弹图片的大小
    bomb.fixture = love.physics.newFixture(bomb.body, bomb.shape, 0) --把矩形附加到炸弹,密度为1
    bomb.fixture:setRestitution(0) --反弹系数,即碰撞反弹后速度为原来的0.3倍
