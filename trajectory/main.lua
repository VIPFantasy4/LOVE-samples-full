...
local g = 9.8
local function vxf(v, a)
    return v * math.cos(a / rad)
end
local function vyt(v, a, t)
    return v * math.sin(a / rad) - g * t
end
local function yt(v, a, t)
    return v * math.sin(a / rad) * t - 0.5 * g * t * t
end
